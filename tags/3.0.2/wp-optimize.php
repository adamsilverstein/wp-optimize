...
class WP_Optimize {
	...
	public function admin_enqueue_scripts() {
		...
		wp_enqueue_script('wp-optimize-cache-js', WPO_PLUGIN_URL.'js/cache'.$min_or_not.'.js', array('smush-js'), $enqueue_version);
		wp_enqueue_script('wp-optimize-admin-js', WPO_PLUGIN_URL.'js/wpoadmin'.$min_or_not.'.js', array('jquery', 'updraft-queue-js', 'smush-js'), $enqueue_version);
