...
== Upgrade Notice ==
* 3.1.5: Minify - * Cache feature - Do not cache pages with fatal errors,  Do not cache RSS feeds. Page cacheing - Prevent adding the "comment cookie" when ordering on WooCommerce; a recommended update for all.
